    ...
    return (
        <div className='bg-gray-100 overflow-x-hidden'>
            <div className='container bg-white px-4 mx-auto pt-10 md:pt-20 pb-3'>
                <div className=" flex flex-col md:flex-row w-full md:items-center justify-around lg:justify-start ">
                    <div className="order-2 md:order-1  w-full md:w-1/6 md:h-full">
                        <div className='h-full flex mt-10 md:mt-0 md:flex-col items-center justify-between md:gap-20'>
                            ...
                            {/* for small screen  */}
                            <Image src={"/displayds.png"} width={100} height={100} alt='' className='block md:hidden' />
                            <Image src={"/displayds.png"} width={100} height={100} alt='' className='block md:hidden' />
                            <Image src={"/displaydf.png"} width={100} height={100} alt='' className='block md:hidden' />
                        </div>
                    </div>

                    {/* Main Image */}
                    <div className="order-1 md:order-2 flex items-center justify-center w-full md:w-3/5 md:h-2/3">
                        <Image src={"/DTMAIN.png"} width={780} height={410} alt='' className='max-w-none w-[300px] h-[150px] md:w-[500px] md:h-[200px] lg:h-[300px] lg:w-[700px]' />
                    </div>
                ...
                <div className=" mt-10 lg:mt-32 text-sm md:text-lg font-sans font-medium tracking-wide md:tracking-[12px]">
                    Parquetry Dining Table With Spider Leg (Tube 7.5 x7.5)
                </div>
                <div className="mt-1 text-xs tracking-wide capitalize">
                    <ul className='ml-4'>
                        <li className='list-disc marker:text-[9px]'>
                            <span className="font-medium mdtext-sm">material</span> : acacia / iron . <span className="font-medium text-sm ml-4">finish</span> : espresso
                        </li>
                    </ul>
                </div>
            </div>
