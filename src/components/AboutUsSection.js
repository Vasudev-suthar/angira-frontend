...
//     return (
//         <div className="bg-[#F4F3F0] border border-[#F4F3F0] min-h-screen py-4">
//             <div className="flex justify-center items-center bg-white mt-5 w-28 sm:w-80 h-10 sm:h-[80px]">
//                 <p className="text-lg sm:text-[27px] font-semibold tracking-wider sm:tracking-[7.2px]">About Us</p>
//             </div>
...
//                                 <p className=" text-xs sm:text-lg leading-6 sm:leading-8 tracking-wider">
...
//                                 </p>
//                                 <p className="text-xs sm:text-lg leading-6 sm:leading-8 tracking-wider mt-1 sm:mt-4">
...
//                                 </p>
//                                 <p className="text-xs sm:text-lg leading-6 sm:leading-8 tracking-wider mt-1 sm:mt-4 font-semibold">
...
export default function AboutUsSection() {
    ...
    return (
        <div className="bg-[#F4F3F0] border border-[#F4F3F0] py-4">
            <div className="flex justify-center items-center bg-white mt-5 w-28 sm:w-80 h-10 sm:h-[80px]">
                <p className="text-lg sm:text-[27px] font-normal tracking-wider sm:tracking-[7.2px]">About Us</p>
            </div>
            <div className="relative h-auto sm:pb-4 flex">
                <div className="w-full bg-[#F4F3F0]">
                    <div className="inset-0 flex flex-wrap sm:mt-6">
                            ...
                            <div className="my-4 sm:my-8">
                                <div className="capitalize">
                                    ...
                                    <div className={`text-xs sm:text-lg leading-6 sm:leading-8 tracking-wider mt-1 sm:mt-4 ${isExpanded ? '' : 'hidden sm:block'}`}>
                                        ...
                                        <p className="mt-1 sm:mt-4 font-semibold">
                                            Choose Angira Art Exports as your trusted partner, and let us exceed your expectations in fulfilling your furniture requirements.
                                        </p>
                                    </div>
